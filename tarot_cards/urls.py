...
urlpatterns = [
    path('tarot-suits/', views.TarotSuitListView.as_view(), name='tarot_suits'),
    path('tarot-suits/<slug:slug>/', views.CardsListView.as_view(), name='cards_list'),
    path('suit-description/<slug:slug>/', views.TarotSuitDetailView.as_view(), name='suit_description'),
