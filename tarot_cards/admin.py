    ...
    fieldsets = (
        ...
        ('Общее значение',
         {'fields': ('general_meaning', 'general_up', 'general_down', 'general_up_tags', 'general_down_tags'),
          'classes': ['wide']}),
        ('Значение для любви',
         {'fields': ('love_up', 'love_down', 'love_up_tags', 'love_down_tags'), 'classes': ['wide']}),
        ('Значение для работы',
         {'fields': ('career_up', 'career_down', 'career_up_tags', 'career_down_tags'), 'classes': ['wide']}),
        ('Значение для финансов',
         {'fields': ('finance_up', 'finance_down', 'finance_up_tags', 'finance_down_tags'), 'classes': ['wide']}),
        ('Прошлое, настоящее, будущее',
         {'fields': ('past_meaning', 'present_meaning', 'future_meaning'), 'classes': ['wide']}),
